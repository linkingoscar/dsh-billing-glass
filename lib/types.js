 ...
 * @property {string=} source 可持久化的价格来源/目录版本。
 */
 ...
 * @property {"model_unknown"|"pricing_unknown"|"subscription_plan"=} unpricedReason
 ...
 * @property {{source: string, mode: string, cny: {input:number,cacheRead:number,output:number}, usd: {input:number,cacheRead:number,output:number}}=} pricingSnapshot
 */
 ...
 * @property {"subscription_plan"=} pricingUnavailableReason 套餐零价目录的明确未计价原因。
